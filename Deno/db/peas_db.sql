...
-- Started on 2025-04-01 23:49:11
...
--
-- TOC entry 5019 (class 0 OID 73823)
-- Dependencies: 231
...
--
-- TOC entry 5018 (class 0 OID 73810)
-- Dependencies: 230
-- Data for Name: documents; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.documents (id, title, pages, publication_date, file, category_id, volume, department, abstract, topic_ids, author_ids) FROM stdin;
1	das	\N	2024-01-01	./filepathpdf/sample_upload.pdf	4	Volume-1	cbit	asdasd	{}	{}
2	sample 09	\N	2024-01-01	./filepathpdf/sample_upload.pdf	4	none	cbit	asdasdasd	{}	{}
3	sample 09	\N	2024-01-01	./filepathpdf/sample_upload.pdf	4	none	cbit	asdasdasd	{}	{}
4	sample 09	\N	2024-01-01	./filepathpdf/sample_upload.pdf	4	none	cbit	asdasdasd	{}	{}
5	sample05	\N	2024-01-01	./filepathpdf/sample_upload.pdf	1	none	cbit	adasdasd	{}	{}
6	test033	\N	2024-01-01	./filepathpdf/sample_upload.pdf	3	none	cbit	test for modal	{}	{}
7	admin test	\N	2024-01-01	./filepathpdf/sample_upload.pdf	4	none	cbit	asdasda	\N	\N
8	man	\N	2024-01-01	./filepathpdf/sample_upload.pdf	4	none	cbit	asdasdagj	\N	\N
9	new title sampe	\N	2024-01-01	./filepathpdf/sample_upload.pdf	4	none	cbit	asdasdafghcvn	{}	{3dc1aa42-c73b-4a56-b397-8d8b404334cd}
\.
...
--
-- TOC entry 5023 (class 0 OID 73855)
-- Dependencies: 235
...
--
-- TOC entry 5025 (class 0 OID 73873)
-- Dependencies: 237
...
--
-- TOC entry 5016 (class 0 OID 73803)
-- Dependencies: 228
...
--
-- TOC entry 5027 (class 0 OID 73888)
-- Dependencies: 239
...
--
-- TOC entry 5021 (class 0 OID 73839)
-- Dependencies: 233
...
SELECT pg_catalog.setval('public.tokens_id_seq', 146, true);
...
-- Completed on 2025-04-01 23:49:11
